...
.DATA
  A DB 0
  v DB 0
  welcomemsg db 1 dup(0ah),4 dup("   "),2 dup(" "),"           WELLCOME TO SNAKE GAME          ",2 dup(" "),4 dup("   "),9 dup(" "),'$'
  startmsg db 11 dup(0ah),4 dup(">> "),2 dup(" "),"         press 'S' to start the game       ",2 dup(" "),4 dup(">> "),9 dup(" "),'$'
  ...
  Exitmsg db 1 dup(0ah),4 dup(">> "),2 dup(" "),"             press 'E' to exit             ",2 dup(" "),4 dup(">> "),9 dup(" "),'$'
...
CHECK_FOOD PROC
    ...
    INC SNAKE_SIZE
    ADD SC_INT,5
    SUB FOOD_DX,8 ;RAND HERE
    ADD FOOD_CX,8 ;RAND HERE
    CALL DRAW_FOOD
    CALL SHOW_SCORE
FIN2:
    RET
